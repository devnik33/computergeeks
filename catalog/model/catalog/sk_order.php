<?php
class ModelCatalogSkOrder extends Model {

	public function getOrder($order_id) {
		$order_query = $this->db->query("
			SELECT 
			*,
			o.date_added as oshistospouseeksimparrose,
			(
				SELECT CONCAT(c.firstname, ' ', c.lastname) FROM " . DB_PREFIX . "customer c
		...
		if ($order_query->num_rows) {
			...
			return array(
				...
				'date_added'              => $order_query->row['oshistospouseeksimparrose'],
				'date_modified'           => $order_query->row['date_modified'],
				'source_id'               => $order_query->row['source_id'],
	...
	public function getOrders($data = array(), $addedSinceDate= '1970-01-01 10:00:00') {
		$sql = "SELECT 
				o.order_id, 
				...
				(
					...
					o.shipping_code, o.total, o.currency_code, 
					o.currency_value, o.date_added, o.date_modified,
					source_id
				FROM `" . DB_PREFIX . "order` o
				INNER JOIN " . DB_PREFIX . "customer c on c.customer_id = o.customer_id
				WHERE o.date_added >= '".$addedSinceDate."'
				";
